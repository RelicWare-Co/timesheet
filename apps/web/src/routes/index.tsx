...
const HomeComponent = () => (
  <div className="container mx-auto px-4 sm:px-8 py-12 md:py-24 max-w-7xl">
    ...
    <div className="grid gap-px bg-foreground/10 border border-foreground/10 md:grid-cols-2 lg:grid-cols-3">
      ...
      <Link
        to="/registrar"
        className="group relative bg-background p-8 md:p-12 hover:bg-foreground hover:text-background transition-colors duration-300 md:col-span-2 lg:col-span-1 min-h-[320px] flex flex-col justify-between"
      >
        <div>
        ...
        <div className="flex justify-end">
          <ArrowRight
            className="size-12 -rotate-45 group-hover:rotate-0 transition-transform duration-500 ease-spring"
            strokeWidth={1.5}
          />
        </div>
      </Link>
      ...
      <Link
        to="/resumen"
        className="group relative bg-background p-8 md:p-12 hover:bg-foreground hover:text-background transition-colors duration-300 min-h-[320px] flex flex-col justify-between"
      >
        <div>
